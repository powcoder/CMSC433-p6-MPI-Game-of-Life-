 ...
 * sample_mpi.c:
 *
 * ***NOTE***: For this project (p6), this file NEED NOT to be CHANGED.
 * The program is provided for your reference.
 *
 *
 * A sample MPI program demonstrating how MPI works in a C program.
 * ========-========-========-========-========-========-========-======== */
...
int main(int argc, char *argv[]) {
	...
	err = MPI_Comm_size(MPI_COMM_WORLD, &ntasks); /* Get number of tasks */
